...
for question in questions:
    ...
    if(question[5] == a):
        ...
        print(f"You won {prizes[i]}! Your total prize is {total_prize}.")
    else:
        print(f"Incorrect, the correct answer was {['a', 'b', 'c', 'd'][question[5] - 1]}")
        print(f"Game over! You won a total of {total_prize}.")
        break
    i += 1
if i == len(questions):
    print(f"Congratulations! You answered all questions correctly and won a total of {total_prize}!")